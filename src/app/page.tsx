...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Appwrite doesn't have a direct equivalent to onAuthStateChange in the same way,
    // but we can poll or rely on the initial check and explicit login events.
    // For simplicity and since we redirect on page load if logged in, this is sufficient.
