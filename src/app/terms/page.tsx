          ...
          <section className="space-y-8">
            <div>
              ...
              <p className="text-[#1A1A1A]/80 leading-relaxed">
                By accessing or using CheckBeforeCommit (the &quot;Service&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to abide by the above, please do not use this service.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[#1A1A1A]/80 leading-relaxed">
                CheckBeforeCommit provides tools for repository analysis and technical insights. We reserve the right to modify, suspend, or discontinue any part of the Service at any time without notice. We aren&apos;t liable for any such changes. Permission is granted to temporarily use the materials (information or software) on CheckBeforeCommit&apos;s website for personal, non-commercial transitory viewing only.
              </p>
